...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Zijn er verborgen kosten of transactiekosten?", acceptedAnswer: { "@type": "Answer", text: "Nee. De prijs op de prijzenpagina is wat je betaalt. Bij ticketverkoop betaal je de standaard transactiekosten van Stripe (je eigen account), niet aan ons." } },
