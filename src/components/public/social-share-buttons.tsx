...
export function SocialShareButtons({ url, title, primaryColor }: Props) {
  ...
  return (
    <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide py-0.5">
      <span className="text-xs text-gray-400 shrink-0">Delen:</span>

      <a
        href={whatsappUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-full border text-xs font-semibold transition-colors active:scale-95"
